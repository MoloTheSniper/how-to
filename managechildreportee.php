...
header("Cache-Control: max-age=300, must-revalidate");
    ...
    if($_SESSION['id'] == '') //checking if a user is logged in
    {
...
<?php
 //------------------------------code for allowing the schedule creation of the current employee-----------------//
...
//-------------------end of creating tasks for current employee--------------------------//
 ?>


<?php

//------------------------code fore showing schedule as well as deleting tasks foe new employee-------------------//
...
//------------------end of showing tasks and deleting current employee tasks----------------------------------------------------//
?>