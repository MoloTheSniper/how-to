...
<?php
	//------------------------------------------code for updating a task for logged in user ----------------------------------------------//
...
<div class ="row" id="inputHolder" >
			...
			<div class="col-xl-12 offset-xl-0 col-lg-12 col-md-12 offset-md-0  col-sm-12">
					...
					<form action='updateself.php' method='POST'>					
						...
						<input placeholder='Enter task date...' type ='date' name = "startdatePost"  class='lgInput'/><br/>

                        <label class ='lgLabel'>End Date</label>
						<input placeholder='Enter task date...' type ='date' name = "enddatePost"  class='lgInput'/><br/>
						<div class ="row">
							<div class ="col-2">
							...
							<div class="col-2">
								...
								<input placeholder='Enter task end...' type ='time' name = "endtimePost"  class='lgTimeInput'/><br/>
							</div>
						</div>
