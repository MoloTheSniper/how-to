					...
					<form action='updatetask.php' method='POST'>					
						...
						<div class ="row">
							<div class ="col-2">
								...
								<input placeholder='Enter start time...' type ='time' name = "starttimePost"  class='lgTimeInput'/>
							</div>

							<div class="col-2">
								<label class ='lgLabel'>End Time</label>
								<input placeholder='Enter end time...' type ='time' name = "endtimePost"  class='lgTimeInput'/><br/>
							</div>
						</div>
