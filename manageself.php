...
//--------deleting a task from  database---------------------//
    ...
    //-----------------------------end of deleting tasks------------//
?>


<?php

//------------------------------creating a task specifically for the session holder------------//
...
{ 
    ...
    $duplicate = mysqli_query($conn,"SELECT * FROM tbschedule WHERE userid = '$UserID' AND start_time = '$startTime' AND end_time = '$endTime'  AND start_date = '$startDate' AND end_date = '$endDate'");
    ...
    else
    {
      if($startTime == "" || $endTime == "" || $startDate == "" || $endDate == "" ||  $title == "" || $description == "")
      {
        ...
        $query = "INSERT INTO tbschedule (userid,start_date,end_date,start_time,end_time,title,description) VALUES ('$UserID',' $startDate','$endDate','$startTime','$endTime','$title','$description')";
...
//-------------------Task COUNT-------------------//
$TaskCount = 0;
$queryCount = "SELECT * FROM tbschedule WHERE userid = '$UserID'";
...
<?php
//-------------------------- code for showing task creation form ------------------------------//
$queryUser = "SELECT * FROM tbusers WHERE idt = '$UserID' ";
$userFirstname = '';
$userSurname = '';
...
<?php
//----------------------------code for deleting and showing tasks-------------------------------------//
$queryShow = "SELECT * FROM tbschedule WHERE userid = '$UserID'";
                ...
                <form action="manageself.php" method="post">
					<div class="myCard">                     
                        ...
                        <div class ="row">
                            ...
                            <div class="col-6">
                                <form action="updateself.php" method="POST" >
                                    <input type="hidden"  name="user_task" value="'.$CurrentTask.'">
                                    <input type="hidden"  name="user_stuff" value="'.$_POST['user_stuff'].'">
...
//---------------------end of displaying and deleting tasks------------------------/
?>